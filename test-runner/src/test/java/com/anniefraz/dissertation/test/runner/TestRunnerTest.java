...
public class TestRunnerTest {
    ...
    public void setUp() throws URISyntaxException, MalformedURLException {
        ...
        sourceFactory = new SourceFactory(Paths.get(TestConfiguration.TEST_RESOURCES_DIR).toAbsolutePath());
    }
...
/*
    ...
    */
    ...
    public void usesInterfaceAndInterfaceClassOnClassPath() throws Exception {
        ...
        compiler.useOptions("-classpath", TestConfiguration.TEST_RESOURCES_DIR);
        ...
        CacheClassLoader loader = new CacheClassLoader(TestConfiguration.TEST_RESOURCES_DIR);
