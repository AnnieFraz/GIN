...
public class MainRBS {
    ...
    public static void main(String[] args) throws IOException, Exception {
        ...
        AnnaPath annaPath = AnnaPath.getBuilder().setClassName("RecursiveBubbleSort").build();
    ...
    private static void compile(PatchFactory patchFactory, Source source, int noOfEdits) throws Exception {
        ...
        while (i < REPS) {
           ...
           // LOG.info("Which edits: " + patch.getEdits());
            ...
            try {
                compiledClass = InMemoryJavaCompiler.newInstance().compile("RecursiveBubbleSort", outputFileString);
    ...
    private static double sendToOpacitor(String outputString) throws Exception {
        ...
        opacitor.updateCode(Collections.singletonList(new Tuple3<>(testReplacementCode, "", "RecursiveBubbleSort")));
